...
records, _ = load_records_many([str(ROOT / "examples" / "multi-deployment-requests.jsonl")])
report = analyze(records, "examples/multi-deployment-requests.jsonl", generated_at="2026-09-03T12:10:00+00:00")
