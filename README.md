...
<a href="docs/assets/tokenlens-report-overview-20260914-v5.png">
  <img src="docs/assets/tokenlens-report-overview-20260914-v5.png" alt="TokenLens for Azure synthetic report Overview showing consumption and independent optimisation scenarios">
</a>

**Task economics**

<a href="docs/assets/tokenlens-report-task-economics-20260914-v5.png">
  <img src="docs/assets/tokenlens-report-task-economics-20260914-v5.png" alt="TokenLens for Azure synthetic Task economics report showing cost per solved task and execution strategy comparison">
</a>

**Usage &amp; diagnostics**

<a href="docs/assets/tokenlens-report-usage-20260914-v5.png">
  <img src="docs/assets/tokenlens-report-usage-20260914-v5.png" alt="TokenLens for Azure synthetic Usage and diagnostics report showing model and deployment usage charts">
</a>

<p align="center"><em>Deterministic synthetic data · Click any image to open the enlarged PNG.</em></p>

The report has three self-contained views:

- **Overview** remains the default consumption view and shows independent optimisation scenarios.
- **Task economics** measures explicit tasks, attempts, outcomes, cost coverage, cleanup, and equivalent execution strategies.
- **Usage &amp; diagnostics** retains request/token analysis and a safe fallback when task telemetry is absent.
